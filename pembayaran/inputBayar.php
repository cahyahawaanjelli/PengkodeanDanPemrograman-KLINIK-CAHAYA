...
$query = "SELECT A.id AS id_pendaftaran, A.nama_pasien, A.tanggal, A.keluhan, A.jk,
          B.id AS id_tindakan, B.tindakan, B.harga,
...
$queryObat = "SELECT A.id_obat, B.nama_obat, B.harga FROM hasil_periksa A LEFT JOIN obat B ON B.id = A.id_obat WHERE A.id_pendaftaran='$id'";
// Panggil function select
$obat = select($queryObat);
    ...
    if (bayar($_POST) > 0) {
        ...
        echo "
            <script>
                ...
                document.location.href= '../pembayaran/index.php';
            </script>
        ";
        exit;
    } else {
        ...
        echo "
            <script>
                ...
                document.location.href= '../pembayaran/inputBayar.php?id=$id';
            </script>
        ";
    }
}
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Form Pembayar</h6>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                <?php endforeach; ?>
                                                <tr>
                                                    <td colspan="2">Biaya <?= strtolower($pasien["tindakan"]); ?></td>
                                                    <td>Rp. <?= $pasien["harga"]; ?></td>
                                                </tr>
                                                <tr>
                                                    <?php $hargaPeriksa = (int)$pasien["harga"] ?>
                                                    <?php $totalHarga = $hargaObat + $hargaPeriksa ?>
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col md 3">
                                                <label for="pasienBayar">Bayar</label>
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text">Rp.</span>
                                                    <input type="number" class="form-control form-control-user" id="pasienBayar" name="pasienBayar" required>
                                                </div>
                                            </div>
                                            <div class="col md 3">
                                                ...
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text">Rp.</span>
                                                    <input type="text" class="form-control form-control-user" id="kembalian" name="kembalian" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <button type="submit" class="btn btn-info btn-icon-split" name="bayar">
    ...
    <!-- Script perhitungan kembalian -->
    <script>
        $(document).ready(function() {
            $('#pasienBayar').keyup('input', function() {
                let total = parseInt($('#total').val());
                let bayar = parseInt($('#pasienBayar').val());
