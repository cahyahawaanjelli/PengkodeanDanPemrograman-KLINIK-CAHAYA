...
<head>
    ...
    <title>KLINIK CAHAYA - Tambah Tindakan</title>
                    ...
                    <div class="col-md-6">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-info">Form Input Data Tindakan</h6>
                            </div>
                            <div class="card-body">
                                <form action="" method="post">
                                    <div class="form-group">
                                        <label for="tindakan">Nama Tindakan</label>
                                        <input type="text" class="form-control form-control-user" id="tindakan" name="tindakan" placeholder="Masukkan nama tindakan..." required>
                                    </div>
                                    <div class="form-group">
                                        <label for="harga">Tarif Tindakan</label>
                                        <input type="number" class="form-control form-control-user" id="harga" name="harga" placeholder="Masukkan Tarif tindakan..." required>
                                    </div>
