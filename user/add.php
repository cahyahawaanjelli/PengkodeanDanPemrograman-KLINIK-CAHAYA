...
// Susun query untuk menyeleksi data pegawai
$query = "SELECT A.id, A.nama_pegawai FROM pegawai A LEFT JOIN user B ON B.id_pegawai = A.id WHERE username IS NULL";
// Panggil function select
$pegawai = select($query);
...
<head>
    ...
    <title>KLINIK CAHAYA - Tambah User</title>
                    ...
                    <div class="col-md-6">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-info">Form Input Data User</h6>
                            </div>
                            <div class="card-body">
                                <form action="" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-user" id="username" name="username" placeholder="Masukkan username pegawai..." required>
                                    </div>
                                    <div class="form-group">
