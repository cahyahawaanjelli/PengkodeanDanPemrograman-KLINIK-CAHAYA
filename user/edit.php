...
// Panggil function select untuk mengambil data user
$user = select("SELECT A.id, A.username, A.password, A.level, B.nama_pegawai FROM user A LEFT JOIN pegawai B ON B.id = A.id_pegawai WHERE A.id='$id'")[0];
...
<head>
    ...
    <title>KLINIK CAHAYA - Edit User</title>
                    ...
                    <div class="col-md-6">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-info">Form Edit Data User Pegawai <?= $user["nama_pegawai"]; ?></h6>
                            </div>
                            <div class="card-body">
                                <form action="" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-user" id="username" name="username" value="<?= $user["username"]; ?>" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="password">Password</label>
                                        <input type="password" class="form-control form-control-user" id="password" name="password" placeholder="Masukkan password pegawai..." required>
                                    </div>
                                    <div class="form-group">
                                        <label for="confpass">Konfirmasi Password</label>
                                        <input type="password" class="form-control form-control-user" id="confpass" name="confpass" placeholder="Masukkan konfirmasi password..." required>
                                    </div>
                                    <div class="form-group">
