...
$pegawai = select("SELECT * FROM pegawai WHERE id='$id'")[0];
...
<head>
    ...
    <title>KLINIK CAHAYA - Edit Pegawai</title>
                    ...
                    <div class="col-md-6">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-info">Form Edit Data Pegawai</h6>
                            </div>
                            <div class="card-body">
                                <form action="" method="post">
                                    <input type="hidden" name="id" id="id" value="<?= $pegawai["id"]; ?>">
                                    <div class="form-group">
                                        <label for="nama_obat">Nama Pegawai</label>
                                        <input type="text" class="form-control form-control-user" id="nama_pegawai" name="nama_pegawai" value="<?= $pegawai["nama_pegawai"]; ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="nohp">Nomor Handphone</label>
                                        <input type="number" class="form-control form-control-user" id="nohp" name="nohp" value="<?= $pegawai["nohp"]; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="alamat">Alamat</label>
                                        <input type="text" class="form-control form-control-user" id="alamat" name="alamat" value="<?= $pegawai["alamat"]; ?>" required>
                                    </div>
                                    <div class="form-group">
