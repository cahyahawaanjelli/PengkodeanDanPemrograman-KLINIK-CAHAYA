    ...
    if (tambah($_POST) > 0) {
        ...
        echo "
            <script>
                ...
                document.location.href= '../obat/index.php';
            </script>
        ";
    } else {
...
<head>
    ...
    <title>KLINIK CAHAYA - Tambah Obat</title>
                    ...
                    <div class="col-md-6">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-info">Form Input Data Obat</h6>
                            </div>
                            <div class="card-body">
                                <form action="" method="post">
                                    <div class="form-group">
                                        <label for="nama_obat">Nama Obat</label>
                                        <input type="text" class="form-control form-control-user" id="nama_obat" name="nama_obat" placeholder="Masukkan nama obat..." required>
                                    </div>
                                    <div class="form-group">
                                        <label for="jenis">Jenis Obat</label>
                                        <input type="text" class="form-control form-control-user" id="jenis" name="jenis" placeholder="Masukkan jenis obat..." required>
                                    </div>
                                    <div class="form-group">
                                        <label for="satuan">Satuan</label>
                                        <input type="text" class="form-control form-control-user" id="satuan" name="satuan" placeholder="Masukkan satuan obat..." required>
                                    </div>
                                    <div class="form-group">
                                        <label for="harga">harga Obat</label>
                                        <input type="number" class="form-control form-control-user" id="harga" name="harga" placeholder="Masukkan harga obat..." required>
                                    </div>
                                    <div class="form-group">
                                        <label for="stok">Stok Obat</label>
                                        <input type="number" class="form-control form-control-user" id="stok" name="stok" placeholder="Masukkan stok obat..." required>
                                    </div>
